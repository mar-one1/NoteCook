...
//            mRecipe = new Recipe(getResources().getDrawable(R.drawable.ic_search_fill_gray), "jus orange",true);
        ...
        if (!tag.equals("search"))
            adapter_rc_recipeDt = new Adapter_RC_RecipeDt(getContext(),Remotelist_recipe.getValue(), TAG_REMOTE);
        else adapter_rc_recipeDt = new Adapter_RC_RecipeDt(getContext(),Search_list, TAG_REMOTE);
